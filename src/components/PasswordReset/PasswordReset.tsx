      ...
      setModal({
        modal: (
          <Message
            type={"success"}
            body={`Jeśli adres ${
              (responseData as RecoveryPasswordResponse).sentToEmail
            } jest prawidłowy, to został na niego wysłany link do zmiany hasła.`}
          />
        ),
      });
            ...
            <form onSubmit={methods.handleSubmit(formSubmitHandler)}>
              <FormProvider {...methods}>
                ...
                <div className="items-center flex flex-row place-content-between align-middle mt-6">
                  <button className="w-full btn-sm h-10 btn-primary normal-case font-normal text-base rounded-none">
                    Zmień hasło
                  </button>
                </div>
              </FormProvider>
