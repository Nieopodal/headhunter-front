    ...
    <div className="flex flex-row items-center gap-2">
      <button
        ...
        className={`flex flex-row items-center justify-center ${
          currentPageNr === 1 ? "bg-neutral-500" : "bg-neutral-300"
        } w-7 h-7`}
      >
      ...
      <button
        onClick={nextPage}
        className={`flex flex-row items-center justify-center ${
          currentPageNr === totalPagesNr ? "bg-neutral-500" : "bg-neutral-300"
        } w-7 h-7`}
      >
