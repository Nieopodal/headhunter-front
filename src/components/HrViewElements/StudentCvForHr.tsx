...
export const StudentCvForHr = () => {
  ...
  useEffect(() => {
    (async () => {
      await fetchApi(
        user,
        `${apiUrl}/hr/interview/cv/${studentId}`,
        "GET",
        ...
        <div className="xl:flex block xl:flex-row w-full xl:w-full 2xl:w-[1500px]">
          <SideMenu>
            <StudentSummary
              ...
              avatarUrl={
                (apiData as StudentCv).student_github_username
                  ? `https://github.com/${
                      (apiData as StudentCv).student_github_username
                    }.png`
                  : ""
            ...
            />
            <div className="mx-auto w-fit mt-4 sm:hidden xl:block">
              <GoBack />
            </div>
          </SideMenu>

          <div className="w-full mx-2">
            <div className=" w-fit my-4 hidden sm:block xl:hidden">
              <GoBack />
            </div>
