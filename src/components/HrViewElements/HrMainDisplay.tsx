                ...
                <div className="flex justify-center items-center w-full mt-4">
                    <div className="flex flex-col place-content-between bg-base-300 items-center sm:min-w-[600px] lg:min-w-[800px] max-w-[1430px]">
                        ...
                        <div className="w-full px-5 pb-5">
                                ...
                                <div className={`pt-4 ${isFiltering ? "pb-2" : "pb-4"} border-b-[3px] place-content-between border-base-200 flex flex-col`}>
                            ...
                            {studentList?.[0] === undefined && <h2 className="text-2xl mt-3 py-7 text-center font-bold">Brak wyników do wyświetlenia</h2>}
                        </div>
