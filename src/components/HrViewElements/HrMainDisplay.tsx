  ...
  return <div className="flex justify-center items-center w-full mt-4">
      <div className="flex flex-col place-content-between bg-base-300 items-center sm:min-w-[600px] lg:min-w-[800px] max-w-[1430px]">
        ...
        <div className="w-full px-5 pb-5">
          <div
            className={`pt-4 ${
              isFiltering ? "pb-2" : "pb-4"
            } border-b-[3px] place-content-between border-base-200 flex flex-col`}
          >
            <div className={"flex flex-row"}>
              <div className="input-group max-sm:gap-5 flex items-center relative">
                <div className="flex flex-row items-center">
                  ...
                  />
                  <BiSearch className="absolute fill-neutral-500 left-[15px] top-[10px] scale-[110%]" />
                  <button
                  ...
                  >
                    <TbPlayerTrackNext className="scale-[150%]" />
                  </button>
                </div>
              </div>
              ...
              <button
                ...
                className={`cursor-pointer w-min-fit px-4 flex items-center justify-center ${
                  isFiltering
                    ? "btn-active text-base-content"
                    : "bg-base-200 text-neutral-500"
                } gap-1.5`}
              >
                <FaFilter
                  className={`${
                    isFiltering ? "fill-white" : "fill-neutral-500"
                  } min-w-[15%] min-h-[15%]`}
                />
                Filtrowanie
              </button>
            ...
            {isFiltering && (
              <span className={"text-right mt-2 text-success"}>
          ...
          <div className="flex flex-col bg-base-200 gap-3">
            {studentList?.map(
              (student: AvailableStudent | StudentToInterview, index) => (
                <SingleStudent
                  key={index}
                  viewMode={viewMode}
          ...
          {studentList?.[0] === undefined && (
            <h2 className="text-2xl mt-3 py-7 text-center font-bold">
