          ...
          {!checkingUser && !user && (
            <div className="w-screen px-3 sm:w-[350px] flex flex-col">
              ...
              <div className="form-control gap-4 my-4">
                {error && (
                  <div className="w-fit mx-auto">
                    <ResponseParagraph text="Login i/lub hasło są nieprawidłowe." />
                  </div>
                )}
                <div>
                  <Input
                  ...
                  />
                  {errors?.email && (
                    <ResponseParagraph text={errors.email.message!} />
                  )}
                </div>
                <div>
                  <Input
                  ...
                  />
                  {errors?.password && (
                    <ResponseParagraph text={errors.password.message!} />
                  )}
                </div>
              </div>
              <div className="items-center flex flex-row place-content-between align-middle mt-2">
                ...
                <button
                  className={`${
                    apiLoading ? " btn btn-square loading" : ""
                  } w-1/2 sm:w-1/3 btn-sm h-10 btn-primary disabled:btn-primary normal-case font-normal text-base rounded-none`}
                  disabled={apiLoading}
                >
